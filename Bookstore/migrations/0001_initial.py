    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('oid', models.ForeignKey(to='Bookstore.Order')),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recommend_books', models.ManyToManyField(to='Bookstore.Book')),
        ...
        migrations.AddField(
            model_name='order',
            name='books',
            field=models.ManyToManyField(to='Bookstore.Book', through='Bookstore.OrderBookRelation'),
            preserve_default=True,
        ),
    ]
